...
<section id="design" class="section">
  <div class="wrap">
    ...
    <div class="prose">
      <p>The vehicle is a tracked platform with a central differential, a single NEMA 17 stepper and a logic board called Arduino UNO running open loop step control as an engine controller. Two side panels have the chassis installed, and a cabin between them holds all of the electronics and mechanical core. Two track shafts pass through the side panels and turn two drive wheels under 148 hand-welded track links.</p>
      <p>I borrowed the shape from a 1916 supply Mark-1 tank-based tracked vehicle - specifically, the unique rhomboidal silhouette. I did not borrow all of the mechanics and some of the choices are unique one-of-a-kind engineering decisions. The way 1916 vehicle steered was with something called brake bands across an epicyclic gear. This build steers passively through a bevel gear differential, and I left the electrical and control side open so a future upgrade can be easilly contributed without changing the structural parts of this project.</p>
