  ...
  <div class="wrap">
    ...
    <div class="reflect">
      <div class="reflect__group">
        ...
        <p>One side of the track came out looser than the other. The two batches of track links printed on the Dreamer and Ender, and the two machines did not run identically on small features. A printed tensioner was added on the loose side as a fix. The next build prints all 148 links on one machine.</p>
      </div>
